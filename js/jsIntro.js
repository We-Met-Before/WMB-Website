...
// gsap.set('.mbMenuBolStory', { opacity: 0 });
...
var introText = new SplitText('.mbWelcomeTheIntro1', { type: 'words,chars' });
...
mbHeroSt.to('.mbWelcomeText', { opacity: 0, y: '-=10%', duration: 0.1 }, '-=1');
